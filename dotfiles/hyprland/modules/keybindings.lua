...
hl.bind("Caps_Lock", hl.dsp.exec_cmd('sh -c "sleep 0.1; swayosd-client --caps-lock"'))
...
hl.bind("XF86MonBrightnessUp",   hl.dsp.exec_cmd("swayosd-client --brightness raise --device acpi_video0 --min-brightness 0"),           { locked = true, repeating = true })
